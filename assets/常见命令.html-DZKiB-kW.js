import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as a,e as n,a as i,f as s}from"./app-p3jFODVl.js";const l={},r=i("p",null,"reids的命令太多啦，根本学不完啊",-1),d=s(`<h2 id="一、通用命令" tabindex="-1"><a class="header-anchor" href="#一、通用命令"><span>一、通用命令</span></a></h2><p>通用指令，是指所有类型都可以使用指令</p><div class="language-text" data-ext="text" data-title="text"><pre class="language-text"><code>
KEYS：查看符合模板的所有key
